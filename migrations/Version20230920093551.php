 ...
 */
final class Version20230920093551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD fullname VARCHAR(255) DEFAULT NULL, ADD show_fullname TINYINT(1) NOT NULL, DROP name, DROP created_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD name VARCHAR(20) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP fullname, DROP show_fullname');
    }
}
